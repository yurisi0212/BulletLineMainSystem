...
class CommandMap {
    ...
    public static function registerCommands(){
        ...
        Server::getInstance()->getCommandMap()->register(self::plugin,new WarpCommands("rule","チュートリアルが行える『チュートリアルワールド』へ移動します","/rule"));
        Server::getInstance()->getCommandMap()->register(self::plugin,new WarpCommands("lobby","色々な惑星に飛べる『ロビーワールド』へ移動します","/lobby"));
